...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SpellCheckIndexRebuilder"/> class.
    /// </summary>
    public class SpellCheckIndexRebuilder : IIndexRebuilder
    {
        private readonly IBackgroundTaskQueue _backgroundTaskQueue;
        private readonly IMainDom _mainDom;
        private readonly IRuntimeState _runtimeState;
        private readonly ILogger<SpellCheckIndexRebuilder> _logger;
        ...
        public SpellCheckIndexRebuilder(
            IMainDom mainDom,
            IRuntimeState runtimeState,
            ILogger<SpellCheckIndexRebuilder> logger,
        ...
        private void RebuildIndex(string indexName, TimeSpan delay, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (IIndexPopulator populator in _populators.Where(x => x is SpellCheckIndexPopulator))
                    {
        ...
        private void RebuildIndexes(bool onlyEmptyIndexes, TimeSpan delay, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                else
                {
                   ...
                   IIndex[] indexes = _examineManager.Indexes.Where(x => x.Name == _options.IndexName).ToArray();
